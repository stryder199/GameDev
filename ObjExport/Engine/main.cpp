...
bool LoadDataStructures(string filename, int vertexCount, int textureCount, int normalCount, int faceCount)
{
	...
	for(int i=0; i<faceIndex; i++)
	{
		...
		{
			fout << "mtl " << allMaterials[materialFaceIndex[i]].Ns << ' ' << allMaterials[materialFaceIndex[i]].Ka_r << ' ' <<	allMaterials[materialFaceIndex[i]].Ka_g <<
				' ' << allMaterials[materialFaceIndex[i]].Ka_b << ' ' << allMaterials[materialFaceIndex[i]].Kd_r << ' ' << 	allMaterials[materialFaceIndex[i]].Kd_g << ' ' <<
				allMaterials[materialFaceIndex[i]].Kd_b << ' ' << allMaterials[materialFaceIndex[i]].Ks_r << ' ' << allMaterials[materialFaceIndex[i]].Ks_g << 
