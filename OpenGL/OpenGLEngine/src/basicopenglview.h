...
public:
	...
	* removes all occurrences of the geometry with the given filename
	...
	*/
	void scaleGeometries(Vector3 m_ScaleFactor);
	void rotateGeometries(Vector3 rotVec);
	void translateGeometries(Vector3 transVec);
...
protected:
	...
	* over our widget
	* use the QMouseEvent class members to access the mouse information
	*/
