...
void PlayerClass::Initialize( MeshClass* objMesh, XMFLOAT3 pos, XMFLOAT3 scale, int totalHealth, int totalShields, int totalEnergy, int energyCost, int torpedos)
{
    m_mesh = objMesh;
    m_pos = pos;
    m_scale = scale;
